...
router.get('/etudiant/:studentId', autoriserRoles('admin', 'professeur', 'étudiant'), ctrl.notes);
router.get('/etudiant/:studentId/moyenne', autoriserRoles('admin', 'professeur', 'étudiant'), ctrl.moyenne);
