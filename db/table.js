...
// On doit utiliser une fonction async car TOUTES les opérations
async function initDatabase() {
    ...
    // La méthode "batch" est utilisée pour exécuter plusieurs commandes SQL en une seule opération, ce qui peut améliorer les performances et réduire le nombre de requêtes envoyées à la base de données. Cela permet de créer toutes les tables nécessaires en une seule étape, plutôt que d'exécuter chaque commande individuellement.
    await db.batch([
